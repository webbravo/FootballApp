...
const { Followers } = require("../../models/connection");
const { body } = require("express-validator");

const { createToken, hashPassword, verifyPassword } = require("./token/tokens");
...
exports.signup = async (req, res) => {
  try {
    const { email, firstName, lastName, username, phone } = req.body;
